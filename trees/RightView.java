...
public class RightView
{
  ...
  private static void findRightView( TreeImpl root,Map<Integer,Integer> map ,int level)
  {
    if(root==null) return;
      map.put( level,root.val);
    if(root.left!=null) findRightView( root.left,map,level+1 );
    if(root.right!=null) findRightView( root.right,map,level+1 );
  }
